...
public class Transaction: WebApiEntity
{
    ...
    public override func mapping(_ map: Map)
    {
        ...
        self.bookingDate            <- (map["bookingDate"], CustomDateFormatTransform(formatString: CSCorporateSDK.DateTimeFormat))
        ...
        self.valuationDate          <- (map["valuationDate"], CustomDateFormatTransform(formatString: CSCorporateSDK.DateTimeFormat))
